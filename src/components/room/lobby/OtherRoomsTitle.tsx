...
function OtherRoomsTitle({ children }: { children: React.ReactNode }) {
  return (
    <article className="lg:pt-[40px] max-sm:pt-[2rem]">
      <div className="flex flex-col justify-start lg:max-w-[1000px] max-sm:w-[22rem]">
        <p className="lg:text-[40px] max-sm:text-[1.8rem]	font-semibold">모집 중</p>
        <div className="flex flex-row gap-x-[16px] lg:mt-[24px] max-sm:mt-[1rem] w-1/4">
