...
import { useChatDataQuery } from '@/query/useQueries/useChattingQuery';
...
const SideBar = ({ chatRoomId }: { chatRoomId: string }) => {
  ...
  return (
    <div className="max-h-[calc(100vh-90px)] min-h-[36rem] overflow-y-auto pt-8 px-4 ease-in-out duration-1000 w-full lg:w-96 max-sm:w-[22rem]">
